...
bool operator==(const ::action_controller::MultiDofFollowJointTrajectoryAction_<ContainerAllocator1> & lhs, const ::action_controller::MultiDofFollowJointTrajectoryAction_<ContainerAllocator2> & rhs)
{
