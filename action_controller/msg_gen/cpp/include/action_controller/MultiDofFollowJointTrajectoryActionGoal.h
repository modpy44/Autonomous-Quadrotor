...
bool operator==(const ::action_controller::MultiDofFollowJointTrajectoryActionGoal_<ContainerAllocator1> & lhs, const ::action_controller::MultiDofFollowJointTrajectoryActionGoal_<ContainerAllocator2> & rhs)
{
