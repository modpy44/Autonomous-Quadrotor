...
bool operator==(const ::action_controller::MultiDofFollowJointTrajectoryFeedback_<ContainerAllocator1> & lhs, const ::action_controller::MultiDofFollowJointTrajectoryFeedback_<ContainerAllocator2> & rhs)
{
